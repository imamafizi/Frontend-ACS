...
import useCreateSWA from "@/hooks/api/swa/useCreateSWA";
...
const SWA = () => {
  ...
  const { mutateAsync: createSWA, isPending } = useCreateSWA();
  ...
  const handleSubmit = async (e) => {
    ...
    await createSWA(transformedData);
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <form
        ...
        className="p-6 bg-white shadow-md rounded-md w-full max-w-7xl my-5"
      >
        <h3 className="text-2xl font-semibold mb-4 text-center">
          Stop Working Authority Form
        </h3>
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
              ...
              <tr>
                <th colSpan={4} className="px-6 py-3">
                  <h4 className="text-lg font-bold mb-2">
                    A. Observer Data (Swa Is Initiated/Reported By)
                  </h4>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="bg-white ">
                <th
                  scope="row"
                  className="px-6 py-4 font-bold text-gray-600 whitespace-nowrap d"
                >
                  Company
                </th>
              ...
              <tr className="text-xs text-gray-700 uppercase bg-gray-50 ">
                <th colSpan={4} className="px-6 py-3">
                  <h4 className="text-lg font-bold mb-2">
                    B. Observee Data (Swa Is Implemented To)
                  </h4>
                </th>
              </tr>
              <tr className="bg-white border-b ">
